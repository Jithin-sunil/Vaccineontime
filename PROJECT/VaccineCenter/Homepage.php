...
<table width="200" border="1">
  ...
  <tr>
    ...
    <tr>
    <td><a href="HospitalVaccine.php">Add Vaccine</a></td>
  </tr>
  <tr>
    <td><a href="Bookings.php">View Bookings</a></td>
  </tr>
   <tr>
    <td><a href="PostComplaint.php">Post Complaint</a></td>
  </tr>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm px-5 py-3 py-lg-0">
        <a href="index.html" class="navbar-brand p-0">
            <h1 class="m-0 text-primary"><i class="fa fa-tooth me-2"></i>Vaccine On Time</h1>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <a href="PostComplaint.php" class="nav-item nav-link">Grievence</a>
                <a href="../Logout.php" class="nav-item nav-link">Log out</a>
            </div>
            <!-- <button type="button" class="btn text-dark" data-bs-toggle="modal" data-bs-target="#searchModal"><i class="fa fa-search"></i></button> -->
            <a href="HospitalVaccine.php" class="btn btn-primary py-2 px-4 ms-3">Add Vaccine</a>
        </div>
    </nav>
    <!-- Navbar End -->
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="../Assets/Templetes/Main/img/carousel-1.jpg" alt="Image">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="../Assets/Templetes/Main/img/carousel-2.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-3 animated slideInDown">Keep Your Teeth Healthy</h5>
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn">Take The Best Quality Dental Treatment</h1>
