...
<style>
    ...
    input[type="submit"],
    input[type="reset"] {
        background-color: #007b83; /* Teal color for submit button */
        color: white;
        border: none;
        padding: 10px 20px;
        border-radius: 5px;
    ...
    input[type="submit"]:hover {
        background-color: #005f61; /* Darker teal for submit button hover effect */
    }

    input[type="reset"] {
        background-color: #e0e0e0; /* Light gray color for cancel button */
        color: #007b83; /* Teal text color */
        margin-left: 8px; /* Space between buttons */
    }

    input[type="reset"]:hover {
        background-color: #b0bec5; /* Darker gray for cancel button hover effect */
    }
